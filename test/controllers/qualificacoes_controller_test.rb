...
class QualificacoesControllerTest < ActionController::TestCase
  ...
  test "should update qualificacao" do
    patch :update, id: @qualificacao, qualificacao: { cliente_id: @qualificacao.cliente_id, float: @qualificacao.float, nota: @qualificacao.nota, restaurante_id: @qualificacao.restaurante_id, valor_gasto: @qualificacao.valor_gasto }
    assert_redirected_to qualificacao_path(assigns(:qualificacao))
  end
